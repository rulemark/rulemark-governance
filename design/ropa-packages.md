...
- **Bundler:** `tsup` per package, emitting ESM and CJS plus type declarations, with an `exports` map. Subpath exports (`@rulemark/ropa-schemas/enums`) keep imports small.
